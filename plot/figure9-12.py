...
filename = './DATA/mkl-all.csv'
e = count_csv_rows(filename)
with open(filename) as csvfile:
	reader = csv.reader(csvfile)
	rows = [row for row in reader]    
	rownum = e
...
fig.savefig("figure-9-12.jpg",dpi=600,format='jpg',bbox_inches = 'tight')
plt.show()
plt.close()
